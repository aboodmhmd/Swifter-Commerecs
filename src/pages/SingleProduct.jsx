 ...
 console.log(variant1)
  ...
  const fetchSendOrder = async () => {
    ...
    const response = await axios
      .post("http://websitebuild.herokuapp.com/api/Customer/add_product",{name,variant1,variant2,quantity},{headers:{shop:"gamal", "auth-token":user}})
      .catch((err) => {
  ...
  const fetchProductDetail = async (id) => {
    ...
    const response = await axios
      .get(`http://websitebuild.herokuapp.com/api/Customer/show-Product-id/${id}`,{headers:{shop:"gamal"}})
      .catch((err) => {
        console.log("Err: ", err);
        setLoading(false)
      });
