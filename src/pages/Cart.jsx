...
const Cart = () => {
  ...
  const fetchDisCode = async () => {
    ...
    const response = await axios
      .post("http://websitebuild.herokuapp.com/api/validate-discount",{discounts},{headers:{shop:"gamal"}})
      .catch((err) => {
  ...
  const fetchShipping = async () => {
    ...
    const response = await axios
      .post("http://websitebuild.herokuapp.com/api/calculate_shipping",{email},{headers:{shop:"gamal"}})
      .catch((err) => {
        console.log("Err: ", err.response);
        setError(err.response.data.msg)
      });
  ...
  const fetchSendOrder = async () => {
    ...
    const response = await axios
      .post("http://websitebuild.herokuapp.com/api/Customer/place_order",{discounts,note},{headers:{shop:"gamal","auth-token":user}})
      .catch((err) => {
        console.log("Err: ", err.response);
        setError(err.response.data.msg)
      });
