...
const Navbar = () => {
    ...
    const fetchSearch = async (w) => {
        ...
        const response = await axios
          .get(`http://websitebuild.herokuapp.com/api/Customer/search-product/${query}`,{headers:{shop:"gamal"}})
          .then((resp) => {
        ...
        return (
            ...
            <Container  style={{backgroundColor: `${primary}`}}>
                <Wrapper>
                    ...
                    <Link to="/" style={{textDecoration:"none"}}><Logo style={{fontFamily:`${font}`}}>gamal SHOP</Logo> </Link>
